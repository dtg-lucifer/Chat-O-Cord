...
import { getConversationByID, getConversationMessages } from "../../../../utils/api";
import { BiPhoneCall } from "react-icons/bi";
import myPic from "../../../../assets/my_pic.jpg";
import { FaVideo } from "react-icons/fa";
import { Conversation, Message as MessageType } from "../../../../types/ComponentProps/Conversation";
    ...
    <MainWrapper>
      ...
      <ConversationWrapper>
        {messages.map((msg, i, msgs) => {
          return <Message key={msg.id} recipient={activeChat?.recipient} currentIndex={i} messages={msgs} {...msg} />;
        })}
      </ConversationWrapper>
      <ConversationInput name={activeChat?.recipient.userName} id={activeChat?.recipient._id} />
    </MainWrapper>
  );
};
